...
class VixCurveStrategy(Strategy):
    ...
    def __init__(self):
        ...
        Strategy.__init__(self, 'vix_curve')
    ...
    def get_default_settings(self):
        ...
        default_settings['fd'] = [21 * short_month, 21 * long_month]
        default_settings['short_ticker'] = default_settings['vol_fut_series'] \
                                      + str(short_month)
        default_settings['long_ticker'] = default_settings['vol_fut_series'] \
                                     + str(long_month)
        default_settings['index_fut_ticker'] = default_settings['index_fut_series'] + "1"

        default_settings['start_date'] = self.default_start_date
        default_settings['price_field'] = 'settle_price'

        default_settings['rolling_beta_com'] = 63
    ...
    def initialize_settings(self, **kwargs):
        ...
        self.settings['price_field'] = kwargs.get(
            'price_field', default_settings['price_field'])
        ...
        self.settings['transaction_cost_per_unit'] = kwargs.get(
    ...
    def initialize_data(self, **kwargs):
        ...
        self.strat_data['vol_fut_returns'] = \
            md.get_rolling_futures_returns_by_series(
                ...
                level_change=True,
                price_field=self.settings['price_field']
        )

        # CM returns
        self.strat_data['cm_vol_fut_returns'] = self.strat_data[
            'cm_vol_fut_prices'].diff(1)
    ...
    def compute_static_strategy(self, **kwargs):
        ...
        self.calc['backtest_data']['front'] \
            = self.strat_data['vol_fut_returns'][st]
        self.calc['backtest_data']['back'] \
            = self.strat_data['vol_fut_returns'][lt] \
            / self.calc['rolling_front_back_beta']
